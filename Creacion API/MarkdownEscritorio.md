...
"***Nota***": Los botones de *Volver* y *Salir* dependen del tipo de usuario:
...
- **Departamentos**: Al pulsar este botón, nos llevará a la página de selección de departamentos.
- **Volver**: Al pulsar este botón, nos llevará de vuelta a la página principal.
